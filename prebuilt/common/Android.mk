...
DEFAULT_APNS_FILE := vendor/soni/prebuilt/common/etc/apns-conf.xml

ifdef CUSTOM_APNS_FILE
CUSTOM_APNS_SCRIPT := vendor/soni/tools/custom_apns.py
...
LOCAL_OVERRIDES_PACKAGES := Launcher2 Launcher3 Launcher3QuickStep QuickStep NexusLauncherRelease
